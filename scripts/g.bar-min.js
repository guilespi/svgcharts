 ...
 */ (function () {
        ...
        function E(f, m, i, b, a, h, n, max_value, symbols, bar_stroke) {
            var n = n || {}, A = n.type || "square",
                ...
                p = f.set(),
                t = f.set(),
                w = (max_value ? max_value : Math.max.apply(Math, h)),
                g = [],
                l = 0,
            ...
            if (Raphael.is(h[0], "array")) {
                ...
                w = (max_value ? max_value : Math.max.apply(Math, n.stacked ? g : w))
            }
            var w = n.to || w,
                b = 100 * (b / (q * (100 + c) + c)),
                c = b * c / 100,
            ...
            for (e = 0; e < q; e++) {
                ...
                for (d = 0; d < (l || 1); d++) {
                    ...
                    o.h = j;
                    o.value = l ? h[d][e] : h[e];
                    o.symbol = l ? symbols[d][e] : symbols[e];//symbols[d];
        ...
        function F(f, m, i, b, a, h, n, max_value, symbols, bar_stroke) {
            ...
            var w = n.to || w,
                r = Math.floor(100 * (a / (q * (100 + c) + c))), //bars width
                a = Math.floor(r * c / 100), //space between bars
                c = [],
                g = i + (a/2), //bar position
                k = (b - 1) / w;
            !n.stacked && (r /= l || 1);
            for (e = 0; e < q; e++) {
                c = [];
                for (d = 0; d < (l || 1); d++) {
                    ...
                    j.h = r;
                    j.value = +v;
                    j.symbol = l ? symbols[d][e] : symbols[e];//symbols[d];
        ...
        Raphael.fn.barchart = function (f, m, i, b, a, h, max_value, symbols, stroke) {
        	bar_stroke = stroke ? "#000" : "none";
            return new E(this, f, m, i, b, a, h, max_value, symbols, bar_stroke);
        };
        Raphael.fn.hbarchart = function (f, m, i, b, a, h, max_value, symbols, stroke) {
        	bar_stroke = stroke ? "#000" : "none";
            return new F(this, f, m, i, b, a, h, max_value, symbols, bar_stroke);
        }
    })();